...
export default function ProcessFruitScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput label="Location" value={tree.city} style={styles.input} editable={false} />
      <TextInput label="Diameter" value={`${tree.diameter.toFixed(2)}m`} style={styles.input} editable={false} />
      <TextInput label="Fruit Status" value={tree.fruitStatus} style={styles.input} editable={false} />
      <View style={styles.buttonGroup}>
        <Button mode="contained" onPress={handleSubmit} style={styles.secondaryButton} icon="image-auto-adjust">
          Process Fruit Image
        </Button>
        <Button mode="contained" onPress={() => console.log('Send result')} style={styles.primaryButton} icon="content-save">
          Send Result
        </Button>
      </View>
    </View>
...
const styles = StyleSheet.create({
  ...
  secondaryButton: { backgroundColor: '#333', borderRadius: 25 },

...
export default function EditUserScreen() {
  ...
  if (!user) {
    return <View style={styles.errorContainer}><Text>User not found.</Text></View>;
  }
      ...
      <SafeAreaView style={styles.safeArea}>
        <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps='handled'>
          <View style={styles.container}>
            ...
            <TextInput label="Full Name" value={name} onChangeText={setName} style={styles.input} autoCapitalize="words" />
            <TextInput label="Email Address" value={user?.email} style={styles.input} editable={false} />
            <TextInput label="Role" value={role} onChangeText={setRole} style={styles.input} autoCapitalize="none" />
            <TextInput label="Date Joined" value={new Date(user?.joined).toLocaleDateString()} style={styles.input} editable={false} />
            <View style={styles.buttonGroup}>
              <Button mode="contained" onPress={() => handleSubmit(userID.toString())} style={styles.primaryButton}>
                Save Changes
              </Button>
            </View>
          </View>
